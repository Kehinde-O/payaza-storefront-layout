...
export function AboutPage({ storeConfig: initialConfig }: AboutPageProps) {
  ...
  const heroImage = aboutConfig?.hero?.heroImage || aboutConfig?.heroImage || 'https://images.unsplash.com/photo-1475721027785-f74ec0f711b1?q=80&w=2070&auto=format&fit=crop';

  const pageTitle = aboutConfig?.hero?.title || aboutConfig?.title || "Empowering Minds, Changing Lives.";
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            {[
              ...
              { label: "Global Events", value: "100+" },
              { label: "Transformations", value: "95%" }
            ].map((stat, idx) => (
