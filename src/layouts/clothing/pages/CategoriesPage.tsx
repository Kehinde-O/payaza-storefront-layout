...
export function CategoriesPage({ storeConfig: initialConfig }: CategoriesPageProps) {
  ...
  return (
    <div data-content-ready className="min-h-screen bg-white text-slate-900 font-sans">
       {/* Header */}
       {categoriesHeaderConfig?.show !== false && (
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
               <div className="max-w-3xl animate-fade-in-up">
                  ...
                  <h1 className="text-4xl lg:text-5xl font-bold tracking-tight text-gray-900 mb-6">
                    {categoriesHeaderConfig?.title || "Shop by Category"}
                  </h1>
                  <p className="text-lg text-gray-600 leading-relaxed max-w-2xl">
                    {categoriesHeaderConfig?.description || "Explore our comprehensive collection of premium products across various departments. Dive into our curated selections designed to match your style and needs."}
                  </p>
               </div>
            </div>
         </div>
            ...
            {categories.length === 0 ? (
              ...
              <Link
                ...
                data-category-card
                    ...
                    {category.description && categoryGridConfig?.showDescriptions !== false && (
