...
import { Store, User as UserIcon, Package, Settings, LogOut, Heart, Bell, Edit2, Check, Trash2, Lock, Calendar, Clock, Loader2, X, Camera, Truck, BookOpen, Play, Download, ArrowRight, CheckCircle2 } from 'lucide-react';
...
export function AccountPage({ storeConfig }: AccountPageProps) {
  ...
  const handleProfileSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      let updatedUser: CustomerProfile;
      ...
      const updatedUserData: User = {
        ...
        createdAt: user?.createdAt || (updatedUser as any).createdAt // Preserve createdAt
      };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Only show Global Header if NOT inside a store layout (no storeConfig) */}
      {!storeConfig && (
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              <Link href="/" className="flex items-center gap-2 group">
                ...
                <span className="text-xl font-bold tracking-tight text-gray-900">StoreFront</span>
              </Link>
              
              <div className="flex items-center gap-4">
                <span className="text-sm font-medium text-gray-700 hidden sm:block">{user?.firstName} {user?.lastName}</span>
                <div className="w-9 h-9 rounded-full bg-gray-200 overflow-hidden ring-2 ring-gray-100">
                  <AvatarImage src={user?.avatar} alt="Profile" size={36} className="rounded-full" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div className={cn("container mx-auto px-4 sm:px-6 lg:px-8 py-8", storeConfig ? "pt-24" : "")}>
        <div className="flex flex-col lg:flex-row gap-8">
          {/* Sidebar */}
          <div className="w-full lg:w-72 flex-shrink-0">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sticky top-24">
              <div className="mb-6 px-4 pt-4 text-center">
                <div className="w-20 h-20 mx-auto rounded-full bg-gray-100 mb-3 overflow-hidden">
                  <AvatarImage src={user?.avatar} alt="Profile" size={80} className="rounded-full" />
                </div>
              ...
              <nav className="space-y-1">
                {[
                  ...
                  <button
                    ...
                    style={activeTab === item.id && storeConfig ? { backgroundColor: primaryColor } : {}}
                  >
          ...
          <div className="flex-1 min-w-0">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 min-h-[600px] p-6 sm:p-8">
              {/* Profile Tab */}
              {activeTab === 'profile' && (
                  ...
                  <form onSubmit={handleProfileSave} className="space-y-8">
                    ...
                    <div className="flex items-center gap-6 pb-6 border-b border-gray-100">
                      <div className="relative">
                        <div className="w-24 h-24 rounded-full bg-gray-100 overflow-hidden border-2 border-gray-200">
                          {avatarPreview ? (
                            <AvatarImage src={avatarPreview} alt="Profile" size={96} className="rounded-full" />
                          ) : (
                            <AvatarImage src={user?.avatar} alt="Profile" size={96} className="rounded-full" />
                          )}
                        </div>
                        {isEditingProfile && (
                          <div className="absolute bottom-0 right-0">
                            <label className="cursor-pointer">
                              <div className="w-8 h-8 rounded-full bg-black flex items-center justify-center text-white hover:bg-gray-800 transition-colors shadow-lg" style={storeConfig ? { backgroundColor: primaryColor } : {}}>
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-500 mb-3">Upload a new profile picture. JPG, PNG, GIF, or WebP. Max size 5MB.</p>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          ...
                          <input 
                            ...
                            required
                            className={cn(
                              "w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:outline-none transition-all",
                              isEditingProfile 
                        ...
                        <div className="space-y-2">
                          ...
                          <input 
                            ...
                            readOnly
                            className="w-full px-4 py-2.5 rounded-lg border border-gray-200 bg-gray-50 text-gray-500 cursor-not-allowed focus:outline-none" 
                          />
                    ...
                    {isEditingProfile && (
                      <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
                        ...
                        <Button 
                          type="submit" 
                          className="bg-black text-white gap-2 min-w-[120px]" 
                          style={storeConfig ? { backgroundColor: primaryColor } : {}}
                          disabled={isSavingProfile}
                        >
                          {isSavingProfile ? (
                            <>
                          ...
                          >
                            ...
                            <div className="space-y-2 mb-3">
                              {order.items?.map((item, idx) => {
                                ...
                                return (
                                  <div key={item.id || idx} className="flex items-center gap-3 p-2.5 bg-gray-50 rounded-lg">
                                    <div className="w-12 h-12 bg-white rounded-md shadow-sm overflow-hidden flex-shrink-0 relative">
                                      {productImage ? (
                                        <Image src={productImage} fill className="object-cover" alt={productName} unoptimized />
                                      ) : (
                                    ...
                                    <div className="flex-1 min-w-0">
                                      <p className="font-semibold text-sm text-gray-900 truncate">{productName}</p>
                                    ...
                                    <div className="text-right flex-shrink-0">
                                      {(() => {
                                        ...
                                        return (
                                          <p className="font-bold text-sm text-gray-900">{formatCurrency(item.price * item.quantity, itemCurrency)}</p>
                                        );
                                      })()}
                                    </div>
                                  </div>
                            ...
                            <div className="pt-2.5 border-t border-gray-100 flex justify-between items-center">
                              ...
                              {(() => {
                                ...
                                return (
                                  <span className="text-base font-bold text-gray-900">{formatCurrency(order.total, displayCurrency)}</span>
                                );
                              })()}
                            </div>
                          </div>
                ...
                <div className="space-y-6 animate-fade-in">
                  ...
                  {isLoadingData ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-500 mt-2">Book a service to see your appointments here</p>
                    </div>
                  ) : (
                    <>
                      {/* Upcoming Bookings */}
                        ...
                        <div>
                          ...
                          <div className="space-y-4">
                            {bookings.filter(b => b.status === 'confirmed' || b.status === 'pending').map((booking) => (
                              <div key={booking.id} className="border border-gray-100 rounded-2xl p-6 bg-white hover:shadow-md transition-all">
                                <div className="flex flex-col md:flex-row gap-6">
                                  ...
                                  <div className="flex-1">
                                    <div className="flex justify-between items-start mb-2">
                                      <div>
                                        <h4 className="text-xl font-bold text-gray-900">Booking #{booking.id.slice(-6)}</h4>
                                        <p className="text-sm text-gray-500">Service ID: {booking.serviceId}</p>
                                      </div>
                                    ...
                                    <div className="flex flex-wrap gap-4 mt-4 text-sm text-gray-600">
                                      <div className="flex items-center gap-2 bg-gray-50 px-3 py-1.5 rounded-lg">
                                        ...
                                        {new Date(booking.bookingDate).toLocaleDateString(undefined, { weekday: 'short', month: 'long', day: 'numeric' })}
                                      </div>
                                      <div className="flex items-center gap-2 bg-gray-50 px-3 py-1.5 rounded-lg">
                                      ...
                                      <div className="flex items-center gap-2 bg-gray-50 px-3 py-1.5 rounded-lg">
                                        <span className="font-semibold">{formatCurrency(booking.price, (booking as any).currency || storeConfig?.settings?.currency || 'USD')}</span>
                                      </div>
                                    </div>
                                    ...
                                    <div className="mt-6 pt-4 border-t border-gray-100 flex justify-end gap-3">
                                      ...
                                      <Button size="sm" className="bg-black text-white" style={storeConfig ? { backgroundColor: primaryColor } : {}}>
                                        View Details
                                      </Button>
                                    </div>
                                  </div>
                      ...
                      {bookings.filter(b => b.status === 'completed' || b.status === 'cancelled').length > 0 && (
                        <div className="pt-8">
                          <h3 className="text-lg font-semibold text-gray-900 mb-4">Past</h3>
                          <div className="space-y-4">
                            {bookings.filter(b => b.status === 'completed' || b.status === 'cancelled').map((booking) => (
                              <div key={booking.id} className={`border border-gray-100 rounded-2xl p-6 ${booking.status === 'cancelled' ? 'bg-red-50/30' : 'bg-gray-50/50'} opacity-75 hover:opacity-100 transition-all`}>
                                <div className="flex items-center gap-6">
                                  ...
                                  <div className="flex-1">
                                    <h4 className="font-bold text-gray-900">Booking #{booking.id.slice(-6)}</h4>
                                    <p className="text-sm text-gray-500">
                                      {new Date(booking.bookingDate).toLocaleDateString()} • {booking.startTime} - {booking.endTime}
                                    </p>
                                    <p className="text-sm font-medium text-gray-700 mt-1">{formatCurrency(booking.price, (booking as any).currency || storeConfig?.settings?.currency || 'USD')}</p>
                                  </div>
                                  <span className={`px-3 py-1 text-xs font-bold rounded-full ${
                                    booking.status === 'cancelled' ? 'bg-red-50 text-red-700' : 'bg-gray-50 text-gray-700'
                                  }`}>
                                    {booking.status.charAt(0).toUpperCase() + booking.status.slice(1)}
                                  </span>
                                </div>
                  ...
                  {isLoadingData ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {wishlistItems.map((item) => {
                        ...
                        return (
                          <div key={item.id} className="group border border-gray-100 rounded-2xl p-4 hover:shadow-md transition-all relative bg-white">
                            <button 
                            ...
                            <div className="aspect-square bg-gray-100 rounded-xl mb-4 overflow-hidden relative">
                              {product?.image ? (
                                <Image src={product.image} alt={product.name || 'Product'} fill className="object-cover group-hover:scale-105 transition-transform duration-500" unoptimized />
                              ) : (
                                <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200">
                            ...
                            {storeSlug && (
                              <Link href={`/${storeSlug}`} className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-1 hover:text-black">
                                {product?.storeName || storeConfig?.name || 'Store'}
                              </Link>
                            )}
                            
                            <h3 className="font-bold text-gray-900 mb-2 truncate">{product?.name || 'Product'}</h3>
                            
                            <div className="flex items-center justify-between mt-4">
                              <span className="text-lg font-bold">{product?.price ? formatCurrency(product.price, product.currency || storeConfig?.settings?.currency || 'USD') : formatCurrency(0, storeConfig?.settings?.currency || 'USD')}</span>
                              {storeSlug && productSlug && (
                                <Link href={`/${storeSlug}/product/${productSlug}`}>
                                  <Button size="sm" className="rounded-full bg-black text-white px-4" style={storeConfig ? { backgroundColor: primaryColor } : {}}>
                                    View Item
                                  </Button>
                                </Link>
                              )}
                ...
                <div className="space-y-6 animate-fade-in">
                  ...
                  <div className="space-y-4 divide-y divide-gray-100">
                    <div className="flex items-center justify-between py-4">
                      ...
                      <div className="relative inline-flex h-6 w-11 items-center rounded-full bg-black transition-colors" style={storeConfig ? { backgroundColor: primaryColor } : {}}>
                    ...
                    <div className="flex items-center justify-between py-4">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Receive emails about new sales and deals</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between py-4">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Get notified when new products arrive</p>
                      </div>
                      <div className="relative inline-flex h-6 w-11 items-center rounded-full bg-black transition-colors" style={storeConfig ? { backgroundColor: primaryColor } : {}}>
                        <span className="inline-block h-4 w-4 transform rounded-full bg-white transition-transform translate-x-6" />
                      </div>
              ...
              {/* My Learning Tab - Only for Motivational Speaker stores */}
              {activeTab === 'learning' && storeConfig?.layout === 'motivational-speaker' && (
                <div className="space-y-8 animate-fade-in">
                  <div className="flex justify-between items-center">
                    <div>
                      <h2 className="text-2xl font-black text-slate-900 tracking-tight">Learning Hub</h2>
                      <p className="text-slate-500 font-medium">Your personal growth and certification center</p>
                    </div>
                  </div>
                  ...
                  <div className="flex border-b border-slate-100 overflow-x-auto no-scrollbar gap-8">
                    {[
                      ...
                      <button
                        key={sub.id}
                        onClick={() => router.push(`?tab=learning&sub=${sub.id}`)}
                        className={cn(
                          "pb-4 text-xs font-black uppercase tracking-[0.2em] whitespace-nowrap border-b-2 transition-all relative",
                          (searchParams.get('sub') || 'courses') === sub.id
                            ? "text-slate-900"
                      ...
                      >
                        ...
                        {(searchParams.get('sub') || 'courses') === sub.id && (
                          <motion.div 
                            ...
                            className="absolute bottom-[-2px] left-0 right-0 h-0.5 bg-slate-900 rounded-full"
                            style={storeConfig ? { backgroundColor: primaryColor } : {}}
                          />
                        )}
                      </button>
                  ...
                  {/* Courses Sub-tab */}
                  {(searchParams.get('sub') === 'courses' || !searchParams.get('sub')) && (
                    <div className="space-y-10">
                      ...
                      <div className="space-y-6">
                        <div className="flex items-center justify-between">
                          <h3 className="text-sm font-black uppercase tracking-[0.2em] text-slate-400">In Progress</h3>
                          <span className="bg-slate-100 text-slate-900 rounded-full px-3 py-0.5 text-[10px] font-bold border border-slate-200">2 Active</span>
                        </div>
                        <div className="space-y-4">
                          {[
                            { 
                            ...
                            return (
                              <Link
                                key={course.id}
                                href={courseLink}
                                className="group block bg-white border border-slate-100 rounded-3xl p-5 hover:border-slate-300 hover:shadow-xl transition-all"
                              >
                                <div className="flex flex-col sm:flex-row gap-6">
                                  <div className="relative w-full sm:w-48 h-32 rounded-2xl overflow-hidden bg-slate-100 shrink-0 shadow-sm">
                                    <Image
                                  ...
                                  <div className="flex-1 flex flex-col justify-between py-1">
                                    <div className="space-y-1">
                                      <p className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-600">{course.type}</p>
                                      <h4 className="text-xl font-black text-slate-900 leading-tight group-hover:text-primary transition-colors">{course.title}</h4>
                                    </div>
                                    <div className="mt-4 space-y-3">
                                      <div className="flex items-center justify-between text-xs">
                                        <span className="text-slate-400 font-bold uppercase tracking-widest text-[10px]">Progress</span>
                                      ...
                                      <div className="flex items-center justify-between pt-2">
                                        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Last seen {course.lastAccessed}</span>
                                        <span className="flex items-center gap-1.5 text-xs font-black text-slate-900 group-hover:translate-x-1 transition-transform">
                      ...
                      {/* Recently Completed */}
                      <div className="space-y-6">
                        <h3 className="text-sm font-black uppercase tracking-[0.2em] text-slate-400">Recently Completed</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {[
                            ...
                            <div key={i} className="bg-slate-50/50 border border-slate-100 rounded-2xl p-5 group hover:bg-white hover:shadow-md transition-all flex items-center justify-between">
                              <div className="flex items-center gap-4">
                                ...
                                <div>
                                  ...
                                  <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-0.5">{course.type} • {course.completedDate}</p>
                                </div>
                              </div>
                              <Button variant="ghost" size="sm" className="h-8 rounded-lg text-[10px] font-black uppercase tracking-widest hover:bg-slate-100">Review</Button>
                            </div>
                          ))}
                        </div>
                      </div>
                  ...
                  {/* Mentorship Sub-tab */}
                  {searchParams.get('sub') === 'mentorship' && (
                    <div className="space-y-6">
                      <MentorshipProgress 
                        programs={[
                          {
                  ...
                  {searchParams.get('sub') === 'certificates' && (
                    <div className="space-y-8">
                      <div className="flex items-center justify-between">
                        <h3 className="text-sm font-black uppercase tracking-[0.2em] text-slate-400">Verified Credentials</h3>
                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Digital PDF Documents</p>
                      </div>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {[
                          { 
                          ...
                          <CertificateCard 
                            key={cert.id} 
                            certificate={cert} 
                            onDownload={(id) => window.open(`/${storeConfig?.slug}/account/certificates/${id}`, '_blank')} 
                          />
                        ))}
                      </div>
                    </div>
                  ...
                  <div className="pt-12 border-t border-slate-100">
                    <Link href={storeConfig ? `/${storeConfig.slug}/services` : '#'}>
                      <Button className="w-full h-16 rounded-3xl font-black uppercase tracking-[0.2em] shadow-2xl shadow-slate-200 hover:shadow-primary/20 hover:-translate-y-1 transition-all text-sm" style={storeConfig ? { backgroundColor: primaryColor } : {}}>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      {!isChangingPassword ? (
                        <Button 
                          variant="outline" 
                          className="w-full justify-between group h-12 rounded-xl"
                          onClick={() => setIsChangingPassword(true)}
                        >
                          <span>Change Password</span>
                          <Lock className="w-4 h-4 text-gray-400 group-hover:text-black" />
                        </Button>
                      ) : (
                        <form onSubmit={handlePasswordChange} className="p-6 border border-gray-200 rounded-xl space-y-4 bg-gray-50/50">
                          ...
                          <div className="space-y-2">
                            ...
                            <input 
                              ...
                              className="w-full px-4 py-2.5 rounded-lg border border-gray-200 bg-white focus:border-black focus:ring-0 focus:outline-none transition-all"
                              required
                            />
                          </div>
                          <div className="space-y-2">
                          ...
                          <div className="flex justify-end gap-3 pt-2">
                            ...
                            <Button type="submit" className="bg-black text-white" style={storeConfig ? { backgroundColor: primaryColor } : {}}>Update Password</Button>
                          </div>
                        </form>
                      )}
                    </div>
                    ...
                    <div className="pt-8 border-t border-gray-100">
                      ...
                      <Button variant="outline" className="border-red-200 text-red-600 hover:bg-red-50 hover:text-red-700 w-full justify-between h-12 rounded-xl">
