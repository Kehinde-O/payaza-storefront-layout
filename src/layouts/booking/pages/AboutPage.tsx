      ...
      <section data-section="stats" className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            {[
              { label: "Bookings Completed", value: "8k+" },
              { label: "Expert Staff", value: "15+" },
              { label: "Services Offered", value: storeConfig.services?.length ? `${storeConfig.services.length}+` : "20+" },
