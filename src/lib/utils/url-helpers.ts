 ...
 */
export function getStoreUrlPrefix(storeSlug: string): string {
 ...
 */
export function getStoreUrl(storeSlug: string, path: string): string {
 ...
 */
export function getStoreUrlWithQuery(
  storeSlug: string, 
  path: string, 
