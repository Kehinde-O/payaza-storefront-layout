...
class AnalyticsService {
  ...
  private eventQueue: Array<{ params: TrackEventParams; timestamp: number }> = [];
  ...
  async trackEvent(params: TrackEventParams): Promise<void> {
    try {
      ...
      if (utmParams.utmSource) queryParams.set('utm_source', utmParams.utmSource);
      if (utmParams.utmMedium) queryParams.set('utm_medium', utmParams.utmMedium);
      if (utmParams.utmCampaign) queryParams.set('utm_campaign', utmParams.utmCampaign);
      if (utmParams.utmTerm) queryParams.set('utm_term', utmParams.utmTerm);
      if (utmParams.utmContent) queryParams.set('utm_content', utmParams.utmContent);
   ...
   */
  private queueEvent(params: TrackEventParams): void {
