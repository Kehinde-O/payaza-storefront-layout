...
export const api = axios.create({
    ...
    headers: {
        ...
        ...(typeof window !== 'undefined' && window.__TEST_MODE__ ? { 'x-test-mode': 'true' } : {}),
    },
...
api.interceptors.response.use((response) => {
    ...
    const apiError = new ApiError(errorMessage, error.response?.status, error.response?.data?.data || error.response?.data // Fallback to full data if data property doesn't exist
    );
