...
import { getContentSelectors, detectRouteType } from '../lib/content-selectors';
/**
 * Hook to detect when page content is ready for display
 * Uses DOM observation to verify key content elements are present
 */
export function useContentReady({ pathname, enabled = true, minDisplayTime = 300, maxWaitTime = 5000, checkInterval = 100, }) {
